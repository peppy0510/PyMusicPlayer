...
import packctrl
exec(packctrl.get_libraryLoadCMD(__file__))
...
BASS_GetDeviceInfo = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.POINTER(
    BASS_DEVICEINFO))(('BASS_GetDeviceInfo', bass_module))
# BOOL BASSDEF(BASS_Init)(int device, DWORD freq, DWORD flags, void *win, void *dsguid);
BASS_Init = func_type(ctypes.c_bool, ctypes.c_int, ctypes.c_ulong, ctypes.c_ulong,
                      ctypes.c_void_p, ctypes.c_void_p)(('BASS_Init', bass_module))
...
BASS_Set3DFactors = func_type(ctypes.c_bool, ctypes.c_float, ctypes.c_float,
                              ctypes.c_float)(('BASS_Set3DFactors', bass_module))
# BOOL BASSDEF(BASS_Get3DFactors)(float *distf, float *rollf, float *doppf);
BASS_Get3DFactors = func_type(ctypes.c_bool, ctypes.POINTER(ctypes.c_float), ctypes.POINTER(
    ctypes.c_float), ctypes.POINTER(ctypes.c_float))(('BASS_Get3DFactors', bass_module))
...
# *top);
BASS_Set3DPosition = func_type(ctypes.c_bool, ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(
    BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR))(('BASS_Set3DPosition', bass_module))
# BOOL BASSDEF(BASS_Get3DPosition)(BASS_3DVECTOR *pos, BASS_3DVECTOR *vel, BASS_3DVECTOR *front, BASS_3DVECTOR *top);
BASS_Get3DPosition = func_type(ctypes.c_bool, ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(
    BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR))(('BASS_Get3DPosition', bass_module))
...
BASS_MusicLoad = func_type(HMUSIC, ctypes.c_bool, ctypes.c_void_p, QWORD, ctypes.c_ulong,
                           ctypes.c_ulong, ctypes.c_ulong)(('BASS_MusicLoad', bass_module))
...
BASS_SampleLoad = func_type(HSAMPLE, ctypes.c_bool, ctypes.c_void_p, QWORD, ctypes.c_ulong,
                            ctypes.c_ulong, ctypes.c_ulong)(('BASS_SampleLoad', bass_module))
# HSAMPLE BASSDEF(BASS_SampleCreate)(DWORD length, DWORD freq, DWORD chans, DWORD max, DWORD flags);
BASS_SampleCreate = func_type(HSAMPLE, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_ulong,
                              ctypes.c_ulong, ctypes.c_ulong)(('BASS_SampleCreate', bass_module))
...
BASS_StreamCreate = func_type(HSTREAM, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_ulong,
                              STREAMPROC, ctypes.c_void_p)(('BASS_StreamCreate', bass_module))
# HSTREAM BASSDEF(BASS_StreamCreateFile)(BOOL mem, const void *file, QWORD offset, QWORD length, DWORD flags);
BASS_StreamCreateFile = func_type(HSTREAM, ctypes.c_bool, ctypes.c_void_p, QWORD, QWORD,
...
BASS_StreamCreateURL = func_type(HSTREAM, ctypes.c_char_p, ctypes.c_ulong, ctypes.c_ulong,
...
BASS_StreamCreateFileUser = func_type(HSTREAM, ctypes.c_ulong, ctypes.c_ulong, ctypes.POINTER(
    BASS_FILEPROCS), ctypes.c_void_p)(('BASS_StreamCreateFileUser', bass_module))
...
BASS_StreamPutData = func_type(ctypes.c_ulong, HSTREAM, ctypes.c_void_p,
                               ctypes.c_ulong)(('BASS_StreamPutData', bass_module))
# DWORD BASSDEF(BASS_StreamPutFileData)(HSTREAM handle, const void *buffer, DWORD length);
BASS_StreamPutFileData = func_type(ctypes.c_ulong, HSTREAM, ctypes.c_void_p,
                                   ctypes.c_ulong)(('BASS_StreamPutFileData', bass_module))

# BOOL BASSDEF(BASS_RecordGetDeviceInfo)(DWORD device, BASS_DEVICEINFO *info);
BASS_RecordGetDeviceInfo = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.POINTER(
    BASS_DEVICEINFO))(('BASS_RecordGetDeviceInfo', bass_module))
...
BASS_RecordSetInput = func_type(ctypes.c_bool, ctypes.c_int, ctypes.c_ulong,
                                ctypes.c_float)(('BASS_RecordSetInput', bass_module))
...
BASS_RecordStart = func_type(HRECORD, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_ulong,
                             RECORDPROC, ctypes.c_void_p)(('BASS_RecordStart', bass_module))
...
BASS_ChannelGetInfo = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.POINTER(
    BASS_CHANNELINFO))(('BASS_ChannelGetInfo', bass_module))
...
BASS_ChannelFlags = func_type(ctypes.c_ulong, ctypes.c_ulong, ctypes.c_ulong,
                              ctypes.c_ulong)(('BASS_ChannelFlags', bass_module))
...
BASS_ChannelSetAttribute = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_ulong,
...
BASS_ChannelGetAttribute = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_ulong,
...
BASS_ChannelSlideAttribute = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_ulong,
                                       ctypes.c_float, ctypes.c_ulong)(('BASS_ChannelSlideAttribute', bass_module))
...
BASS_ChannelSet3DAttributes = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_int, ctypes.c_float,
                                        ctypes.c_float, ctypes.c_int, ctypes.c_int, ctypes.c_float)(('BASS_ChannelSet3DAttributes', bass_module))
...
BASS_ChannelGet3DAttributes = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.POINTER(ctypes.c_ulong), ctypes.POINTER(ctypes.c_float), ctypes.POINTER(
    ctypes.c_float), ctypes.POINTER(ctypes.c_ulong), ctypes.POINTER(ctypes.c_ulong), ctypes.POINTER(ctypes.c_float))(('BASS_ChannelGet3DAttributes', bass_module))
...
# *vel);
BASS_ChannelSet3DPosition = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(
    BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR))(('BASS_ChannelSet3DPosition', bass_module))
# BOOL BASSDEF(BASS_ChannelGet3DPosition)(DWORD handle, BASS_3DVECTOR *pos, BASS_3DVECTOR *orient, BASS_3DVECTOR *vel);
BASS_ChannelGet3DPosition = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(
    BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR))(('BASS_ChannelGet3DPosition', bass_module))
...
BASS_ChannelSetPosition = func_type(ctypes.c_bool, ctypes.c_ulong, QWORD,
...
BASS_ChannelGetData = func_type(ctypes.c_ulong, ctypes.c_ulong, ctypes.c_void_p,
                                ctypes.c_ulong)(('BASS_ChannelGetData', bass_module))
# HSYNC BASSDEF(BASS_ChannelSetSync)(DWORD handle, DWORD type, QWORD param, SYNCPROC *proc, void *user);
BASS_ChannelSetSync = func_type(HSYNC, ctypes.c_ulong, ctypes.c_ulong, QWORD, SYNCPROC,
                                ctypes.c_void_p)(('BASS_ChannelSetSync', bass_module))
...
BASS_ChannelSetDSP = func_type(HDSP, ctypes.c_ulong, DSPPROC, ctypes.c_void_p,
                               ctypes.c_int)(('BASS_ChannelSetDSP', bass_module))
...
if platform.system().lower() == 'windows':
    ...
    BASS_Init = func_type(ctypes.c_bool, ctypes.c_int, ctypes.c_ulong, ctypes.c_ulong,
                          ctypes.c_ulong, ctypes.c_void_p)(('BASS_Init', bass_module))
    ...
    BASS_SetEAXParameters = func_type(ctypes.c_bool, ctypes.c_int, ctypes.c_float,
                                      ctypes.c_float, ctypes.c_float)(('BASS_SetEAXParameters', bass_module))
    # BOOL BASSDEF(BASS_GetEAXParameters)(DWORD *env, float *vol, float *decay, float *damp);
    BASS_GetEAXParameters = func_type(ctypes.c_bool, ctypes.POINTER(ctypes.c_ulong), ctypes.POINTER(
        ctypes.c_float), ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_float))(('BASS_GetEAXParameters', bass_module))
        ...
        if show_tags:
            ...
            try:
                ...
                print(pytags.TAGS_Read(
                    handle, '%IFV1(%ITRM(%TRCK),%ITRM(%TRCK). )%IFV2(%ITRM(%ARTI),%ICAP(%ITRM(%ARTI)),no artist) - %IFV2(%ITRM(%TITL),%ICAP(%ITRM(%TITL)),no title)%IFV1(%ITRM(%ALBM), - %IUPC(%ITRM(%ALBM)))%IFV1(%YEAR, %(%YEAR%))%IFV1(%ITRM(%GNRE), {%ITRM(%GNRE)})%IFV1(%ITRM(%CMNT), [%ITRM(%CMNT)])'))
            except:
